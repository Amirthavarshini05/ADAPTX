        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSection(
                title: 'Our Mission',
                content: 'AdaptX is dedicated to providing personalized exercise routines that adapt to your mood and health conditions. We believe in making fitness accessible and enjoyable for everyone, regardless of their current state of health or emotional well-being.',
              ),
              const SizedBox(height: 24),
              _buildSection(
                title: 'Features',
              ...
              _buildSection(
                ...
                content: 'By using AdaptX, you agree to our terms of service. Please consult with your healthcare provider before starting any exercise program.',
              ),
              const SizedBox(height: 24),
              _buildSection(
